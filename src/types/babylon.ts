...
/**
 * Props for the BabylonCardRenderer React component
 */
export interface BabylonCardRendererProps {
...
export interface GradientColors {
  startColor: string;  // Hex color string for gradient start
  endColor: string;    // Hex color string for gradient end
}
